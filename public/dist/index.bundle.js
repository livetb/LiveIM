    ...
    value: function bindListener() {
      ...
      this.config.filter_diamond.addEventListener('change', function () {
        ...
        _this.UserMap.forEach(function (user) {
          if (_this.config.filter.diamond && _this.config.filter.star) {
